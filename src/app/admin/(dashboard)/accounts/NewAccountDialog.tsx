...
// 새 계정 추가 다이얼로그 — UI 만. 저장 로직은 v2 /accounts POST 붙는 시점에.
...
const CATEGORY_OPTIONS = [
  ...
  { key: "social", label: "소셜 미디어", emoji: "📱" },
  { key: "editing", label: "디자인 · 편집", emoji: "🎨" },
  { key: "ads", label: "광고", emoji: "📢" },
  { key: "booking", label: "예약 · CRM", emoji: "🗓️" },
...
const SCOPE_OPTIONS: {
  ...
  { key: "all", label: "전사", hint: "모든 구성원이 봅니다" },
  { key: "team", label: "팀", hint: "같은 팀만 봅니다" },
  { key: "project", label: "프로젝트", hint: "프로젝트 멤버만 봅니다" },
];

// mock — 실제로는 /employees, /projects 에서 불러옴.
...
export function NewAccountDialog({ open, onClose }: NewAccountDialogProps) {
  ...
  function submit() {
    // TODO: v2 /accounts POST 연동 (multipart 로 logoFile 함께).
    onClose();
  }
