...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    items: [
      ...
      {
        type: "feature",
        title: "회원·PT 신청 시 얼굴 사진 등록",
        description: [
          "첨단점·화순점에서 회원·PT 신청서를 작성할 때 얼굴 사진을 함께 촬영해요. 센터 출입 시 얼굴 인식에 사용돼요.",
          "사진이 흐리거나 얼굴이 인식되지 않으면 안내 문구가 뜨고 바로 다시 찍을 수 있어요.",
        ],
      },
      {
        type: "feature",
        title: "알림톡 관리 — 지점별 본문·토글 분리",
        description: [
          "각 지점이 알림톡 본문과 발송 ON/OFF 를 따로 관리해요. 한 지점에서 한 변경이 다른 지점에 영향을 주지 않아요.",
          "지점 셀렉터에서 지점을 바꾸면 그 지점 기준으로 본문·토글이 보여요.",
        ],
      },
      // 개선
      {
        type: "improvement",
        title: "전역 알림톡 토글 양방향 cascade",
        description: [
          "전역 알림톡 발송을 끄면 모든 지점이 함께 꺼지고, 다시 켜면 모든 지점이 함께 켜져요.",
          "전역·지점 중 하나라도 꺼져 있으면 알림톡 관리 페이지의 종류별 토글이 시각적으로 OFF·잠금 상태로 바뀌고 안내 배너가 떠요.",
        ],
      },
    ],
  },
